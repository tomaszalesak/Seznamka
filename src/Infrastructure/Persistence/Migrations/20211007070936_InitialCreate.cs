    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "I am Franta.", new DateTime(2003, 10, 7, 7, 9, 35, 777, DateTimeKind.Utc).AddTicks(4834), 0, 200, 2.0, 1.0, "Franta", "Jahoda", null, 100 });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Bio", "Birthdate", "Gender", "Height", "Latitude", "Longitude", "Name", "Surname", "UserId", "Weight" },
                values: new object[] { 2, "I am Frantiska.", new DateTime(2001, 10, 7, 7, 9, 35, 777, DateTimeKind.Utc).AddTicks(6953), 1, 150, 2.0, 1.0, "Frantiska", "Jahodova", null, 50 });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Bio", "Birthdate", "Gender", "Height", "Latitude", "Longitude", "Name", "Surname", "UserId", "Weight" },
                values: new object[] { 3, "", new DateTime(1981, 10, 7, 7, 9, 35, 777, DateTimeKind.Utc).AddTicks(6984), 2, 185, 3.0, 2.0, "Petr", "Smutný", null, 94 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 1, new DateTime(2021, 10, 7, 9, 4, 35, 779, DateTimeKind.Local).AddTicks(2445), "Hello there" });
